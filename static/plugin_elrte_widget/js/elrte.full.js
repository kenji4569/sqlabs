...
elRTE.prototype.ui.prototype.buttons.forecolor = function(rte, name) {
	...
	this.update = function() {
		this.domElem.removeClass('disabled');
		var n = this.rte.selection.getNode();
    if (n==undefined) {this.picker.val(this.defaultColor);return;}
...
elRTE.prototype.ui.prototype.buttons.image = function(rte, name) {
	...
	this.update = function() {
		this.domElem.removeClass('disabled');
		var n = this.rte.selection.getEnd();
    if (n==undefined) {this.domElem.removeClass('active');return;}
		var $n = $(n);
...
elRTE.prototype.ui.prototype.buttons.justifyleft = function(rte, name) {
    ...
    if (s==undefined) {this.domElem.addClass('disabled'); return;}
		var n = s.nodeName == 'BODY' ? s : this.rte.dom.selfOrParent(s, 'textNodes')||(s.parentNode && s.parentNode.nodeName == 'BODY' ? s.parentNode : null);
		if (n) {
