...
'A manager for private messaging between users as in Facebook.': 'Facebookにあるようなユーザー間のプライベートメッセージングのための管理プログラムです。',
...
'A private messaging manager': 'プライベートなメーっせジングのための管理プログラム',
